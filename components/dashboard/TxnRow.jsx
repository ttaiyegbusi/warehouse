...
export default function TxnRow({ txn, onClick }) {
  return (
    <div
      className="row-hover flex items-center px-2 py-4 border-b border-neutral-100"
      onClick={onClick}
    >
      <div className="w-10 flex items-center justify-center text-neutral-500 shrink-0">
        {txn.icon === "download" ? (
      ...
      <div className="flex-1 min-w-0">
        <div className="font-sans text-sm text-black truncate">{txn.type}</div>
        <div className="font-sans text-xs text-neutral-400 mt-1 truncate">
