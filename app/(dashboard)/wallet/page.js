    ...
    >
      ...
      <div className="relative mt-6 flex items-end justify-between">
        <div>
          ...
          <div className="font-sans text-xs mt-0.5 truncate max-w-[180px]">
            {card.holder}
          </div>
        </div>
    ...
    <div className="px-10 py-8 max-w-6xl">
      ...
      <div className="flex items-end justify-between">
        <div>
          ...
          <div className="font-mono text-4xl mt-2">{active.balance}</div>
      ...
      <div className="mt-12 flex items-center justify-between">
        ...
        <div className="text-xs font-mono text-neutral-400">
          {WALLET_CARDS.length} cards
        </div>
      </div>

      <div className="mt-4 flex gap-4 overflow-x-auto scrollbar-hide pb-2 -mx-2 px-2">
        {WALLET_CARDS.map((c) => (
          <PaymentCard
            key={c.id}
            card={c}
